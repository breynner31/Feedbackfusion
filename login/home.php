					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="">Bienvenido <?php echo $user->getNombre(); ?></a>

									<ul class="sub-menu">
										<li><a href="perfil.html">Perfil</a></li>
										<li><a href="registro_tienda/registro.php">Registrar restaurante</a></li>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">
						...
						<p>La mejor calificacion y opiniones de los restaurantes </p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row clearfix">
				...
				<div class="content-column col-lg-6">
					...
					<div class="text">Tu opinión cuenta. Regístrate o inicia sesión para compartir tus experiencias y
						contribuir a la comunidad gastronómica. ¡Tu voz hace la diferencia en la calidad y reputación de
						los restaurantes! </div>
					<!--Countdown Timer-->
					<!-- <div class="time-counter"><div class="time-countdown clearfix" data-countdown="2020/2/01"><div class="counter-column"><div class="inner"><span class="count">00</span>Days</div></div> <div class="counter-column"><div class="inner"><span class="count">00</span>Hours</div></div>  <div class="counter-column"><div class="inner"><span class="count">00</span>Mins</div></div>  <div class="counter-column"><div class="inner"><span class="count">00</span>Secs</div></div></div></div> -->
					<a href="../login/login.php" class="cart-btn mt-3"><i class="fas fa-shopping-cart"></i> Inicia
						Sesion</a>
					<a href="../login/sign-up.php" class="cart-btn mt-3"><i class="fas fa-shopping-cart"></i>
						Registrate</a>
				</div>
			</div>
		</div>
	...
	<div class="abt-section mb-150">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						<!-- <p class="top-sub">	Tutorial en video</p> -->
						<h2>Video <span class="orange-text">Tutorial</span></h2>
						<p>"¡Bienvenido! En este video, te mostraremos paso a paso cómo aprovechar al máximo todas las
							funciones y características de nuestra página web.</p>
						<p>Desde cómo registrarte y acceder a tu cuenta, hasta cómo buscar restaurantes, calificar y
							comentar sobre ellos. Con esta guía visual, aprenderás de manera sencilla y rápida a navegar
							por nuestra plataforma y sacarle el máximo provecho a tu experiencia gastronómica. ¡No te lo
							pierdas!"
						</p>
...
try {
    ...
    // Consulta SQL para obtener todos los datos de la tabla de restaurantes
    ...
    if ($stmt->rowCount() > 0) {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<img src='data:image/jpeg;base64," . $imagen_base64 . "' style='width:150%; height:100%';><br>";

            // Mostrar el nombre del restaurante
            echo "<h3>" . $row["nombre_restaurante"] . "</h3>";

            // Mostrar la dirección del restaurante
            echo "<p>Dirección: " . $row["direccion"] . "</p>";

            // Mostrar el teléfono del restaurante
...
?>
			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<a href="../reviews/news.php" class="boxed-btn">More News</a>
				</div>
			</div>
		</div>
	</div>
