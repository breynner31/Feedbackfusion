			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						...
						// Verificar si el usuario ha iniciado sesión y obtener su email
						...
						try {
							...
							// Consulta SQL para obtener los datos del restaurante asociado al usuario actual
							$sql = "SELECT * FROM restaurante WHERE id_restaurante IN (SELECT id_restaurante FROM user WHERE email = :email)";
				...
				<div>
            	<a href="..\login\registro_tienda\editar.php"><button class="btn btn-primary">Editar</button></a>
				<a href="..\login\registro_tienda\eliminar.php" onclick="return confirmarEliminar();"><button class="btn btn-primary">Eliminar</button></a>

				<script>
					function confirmarEliminar() {
        			if (confirm("¿Estás seguro de que quieres eliminar este restaurante?")) {
            		// Si el usuario confirma, redirigir a eliminar.php
